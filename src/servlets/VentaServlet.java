...
public class VentaServlet extends HttpServlet {
	...
	private void comprar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String numVenta = new VentaService().ultimoNumVenta();
		
		VentaDTO v = new VentaDTO();
		v.setNumVenta(numVenta);
		v.setFecha(fecha);
		...
		if(!carrito.isEmpty())
		{
			ok = new VentaService().transaccion(v, carrito);
		}
		else
		{
	...
	private void agregar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		//Buscar el producto
		ProductoDTO p = new ProductoService().buscar(codProducto);
		...
		{
			request.setAttribute("alerta", "Solo quedan " + p.getStockAct() + " unidades del producto " + p.getDescripcion());
			request.getRequestDispatcher("Productos.jsp").forward(request, response);
		}
	}
	...
	private void editar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(p.getStockAct() >= newCantidad)
		{
			...
			//Se vuelve a agregar el producto actualizado, en la posicion donde estaba y el subtotal
